...
// User Sigin Form
var mySiginForm = document.getElementById('mySiginForm')
mySiginForm.addEventListener('submit', function(eventparameter){
    eventparameter.preventDefault();
    var data = JSON.stringify(signinFormData(mySiginForm));
    console.log(data);
    SigninUser(data);
})
